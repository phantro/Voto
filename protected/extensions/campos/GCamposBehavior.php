...
class GCamposBehavior extends CActiveRecordBehavior {
    ...
    public $campoFechaCreacion = 'Fecha';
    public $campoNavegador = 'Navegador';
    public $campoIp = 'Ip';
    ...
    public function beforeSave($event) {
        ...
        if (($this->getOwner()->getTableSchema()->getColumn($this->campoNavegador) !== null))
        {
            $navegador = null;
            $navegador = $this->getBrowser();
            $this->getOwner()->{$this->campoNavegador} = 'Sistema Operativo: '.$this->getOs().' ; Navegador: '.$navegador['name'] . ' ' . $navegador['version'];
        }
